...
partial class Form_Paint
{
    ...
    private void InitializeComponent()
    {
        ...
        다시실행ToolStripMenuItem = new ToolStripMenuItem();
        ...
        // menuStrip_top
        // 
        menuStrip_top.ImageScalingSize = new Size(20, 20);
        menuStrip_top.Items.AddRange(new ToolStripItem[] { 파일toolStripMenuItem, 편집EToolStripMenuItem });
        ...
        // 파일toolStripMenuItem
        // 
        파일toolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { 새파일NToolStripMenuItem, toolStripSeparator1, 열기OToolStripMenuItem, 저장SToolStripMenuItem, toolStripSeparator2, 인쇄PToolStripMenuItem, 미리보기VToolStripMenuItem, toolStripSeparator3, 종료XToolStripMenuItem });
        파일toolStripMenuItem.Name = "파일toolStripMenuItem";
        파일toolStripMenuItem.Size = new Size(60, 24);
        ...
        // 
        편집EToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { 되돌리기UToolStripMenuItem, 다시실행ToolStripMenuItem, toolStripSeparator4, 오려두기XToolStripMenuItem, 복사하기CToolStripMenuItem, 붙여넣기VToolStripMenuItem, toolStripSeparator5, 모두선택AToolStripMenuItem });
        편집EToolStripMenuItem.Name = "편집EToolStripMenuItem";
        편집EToolStripMenuItem.Size = new Size(61, 24);
        편집EToolStripMenuItem.Text = "편집&E";
        // 
        // 되돌리기UToolStripMenuItem
        // 
        되돌리기UToolStripMenuItem.Name = "되돌리기UToolStripMenuItem";
        되돌리기UToolStripMenuItem.ShortcutKeys = Keys.Control | Keys.Z;
        되돌리기UToolStripMenuItem.Size = new Size(266, 26);
        되돌리기UToolStripMenuItem.Text = "되돌리기(&U)";
        되돌리기UToolStripMenuItem.Click += undo_Click;
        // 
        // 다시실행ToolStripMenuItem
        // 
        다시실행ToolStripMenuItem.Name = "다시실행ToolStripMenuItem";
        다시실행ToolStripMenuItem.ShortcutKeys = Keys.Control | Keys.Shift | Keys.Z;
        다시실행ToolStripMenuItem.Size = new Size(266, 26);
        다시실행ToolStripMenuItem.Text = "다시실행(&R)";
        다시실행ToolStripMenuItem.Click += redo_Click;
        // 
        // toolStripSeparator4
        // 
